;(function(window, document){
    ...
    // 枚举需要被考虑的css属性以构建打印的样式
    var fontStyle = [//这些属性会被继承
        "font",
    ...
    var styleEnum = [...fontStyle,...border,...boxStyle]
    // 打印
    ...
    Print.prototype = {
        ...
        getIframeHeader() {
            ...
            let links = document.querySelectorAll('link'), link = '',style = '';
            ...
            style += "<style>" + (this.options.noPrint ? this.options.noPrint : ".no-print") + "{display:none !important;}</style>"
